...
const OurService = () => {
    return ( 
        ...
        <div className="mx-auto md:w-[95%] md:max-w-[1300px] justify-between items-center flex flex-col space-y-8 md:space-y-0 md:space-x-[12px] md:flex-row transition duration-700 ease-in-out ">
